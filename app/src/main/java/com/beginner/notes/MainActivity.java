...
public class MainActivity extends AppCompatActivity {
   ...
   static ArrayAdapter arrayAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sharedPreferences=this.getSharedPreferences("com.beginner.notes", Context.MODE_PRIVATE);
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                new AlertDialog.Builder(MainActivity.this)
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        SharedPreferences sharedPreferences = MainActivity.this.getSharedPreferences("com.beginner.notes", Context.MODE_PRIVATE);
